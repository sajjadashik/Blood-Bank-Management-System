...
<table>
		<h1>Add Donor</h1>
                ...
                <tr>
                    ...
                    <td>: <input type="text" id="uname" onkeyup="checkuname(this)" placeholder="Username" value="<?php echo $uname; ?>" name="uname"><img src=" "  width="16" height="15" id="pic2"><span id="err_username"></span><br><span id="err_uname" style="color: red;"><?php echo $err_uname; ?> </span>
                    </td>
                </tr>
                <tr>
